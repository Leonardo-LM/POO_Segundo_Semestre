        ...
        while (respuesta != 12) {
            ...
            switch (respuesta) {
                ...
                case 2:
                    ...
                    scaner.nextLine();
                    String nombreMedico = scaner.nextLine();

                    System.out.println("Ingrese el apellido del médico: ");
                    String apellidoMedico = scaner.nextLine();

                    System.out.println("Ingrese la fecha de nacimiento: ");
                    String fechaNacomientoMedico = scaner.nextLine();

                    System.out.println("Ingrese el teléfono del médico: ");
                    String telefonoMedico = scaner.nextLine();

                    System.out.println("Ingrese el rfc del médico: ");
                    String rfc = scaner.nextLine();

                    String idMedico = hospital.generarIdMedico(apellidoMedico, fechaNacomientoMedico);

                    Medicos medico = new Medicos(idMedico, nombreMedico, apellidoMedico, fechaNacomientoMedico, telefonoMedico, rfc);
