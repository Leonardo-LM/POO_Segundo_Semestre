...
public class Paciente extends Usuario {
    ...
    public Paciente(String id, String nombre, String apellidos, LocalDate fechaNacimiento, String tipoSangre, char sexo, String telefono, String contrasenia, String email) {
        super(id, nombre, apellidos, fechaNacimiento, telefono, contrasenia, email ,  Rol.PACIENTE);
